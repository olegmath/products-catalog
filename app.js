...
const courseCopy = [
  {
    ...
    details: {
      ...
      includes: [
        ...
        "<strong>Интенсив 4 — Задание 16 (планиметрия).</strong> Доказательная и вычислительная части, ключевые конфигурации и грамотное оформление.",
        "<strong>Интенсив 5 — Повторение.</strong> Полный прогон, пробники, разбор ошибок, тайминг и стратегия на экзамене.",
      ],
      format: "Живые онлайн-занятия по 3–4 часа: разбор задач у доски, домашки с проверкой преподавателем, доступ к записям.",
  ...
  },
  {
    ...
    details: {
      ...
      includes: [
        ...
        "<strong>Интенсив 4 — Задание 16 (планиметрия).</strong> Доказательство и вычисления, ключевые конфигурации, оформление на полный балл.",
        ...
        "<strong>Интенсив 6 — Задания 14 и 17 (стереометрия и экономика).</strong> Объёмы, углы и расстояния в пространстве; кредиты, вклады и оптимизация в №17.",
  ...
  },
  {
    ...
    details: {
      ...
      format: "Живые онлайн-занятия по 3–4 часа: тренировка на реальных заданиях, домашки с проверкой преподавателем, доступ к записям.",
  ...
  },
  {
    ...
    details: {
      ...
      format: "Живые онлайн-занятия по 3–4 часа: много практики, домашки с проверкой преподавателем, доступ к записям.",
  ...
  },
  {
    ...
    details: {
      ...
      format: "Живые онлайн-занятия по 3–4 часа: разбор заданий и формулировок ответов, домашки с проверкой преподавателем, доступ к записям.",
